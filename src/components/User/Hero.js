                ...
                <div id="heroCarousel" className="carousel slide carousel-fade" data-bs-ride="carousel"
                    ...
                    <div className="carousel-inner" role="listbox">
                        ...
                        <div className="carousel-item active">
                            <div className="carousel-container">
                                <div className="container">
                                    ...
                                    <p className="animate__animated animate__fadeInUp">Lorem ipsum dolor sit amet,
                                        consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                                        dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                                        laboris nisi ut aliquip ex ea commodo consequat.</p>
                                    <a href="#featured-services"
                                       className="btn-get-started scrollto animate__animated animate__fadeInUp">Get
                                        Started</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="carousel-item" >
                            <div className="carousel-container">
                                <div className="container">
                                    ...
                                    <p className="animate__animated animate__fadeInUp">Nam libero tempore, cum soluta
                        ...
                        <div className="carousel-item" >
                            <div className="carousel-container">
                                <div className="container">
                                    <h2 className="animate__animated animate__fadeInDown">Temporibus autem
                                        quibusdam</h2>
                                    <p className="animate__animated animate__fadeInUp">Beatae vitae dicta sunt
                        ...
                        <div className="carousel-item">
                            <div className="carousel-container">
                                <div className="container">
                                    ...
                                    <p className="animate__animated animate__fadeInUp">Neque porro quisquam est, qui
